...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MSI;Initial Catalog=VVPSMSDBV1;User Id=sa;Password=1992;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=true;Integrated Security=false;Column Encryption Setting=enabled;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Applicant>(entity =>
        {
            entity.HasKey(e => e.ApplicantId).HasName("PK__tmp_ms_x__F49C60C1D1D79B5F");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Applicants)
                ...
                .HasConstraintName("FK__Applicant__role___797309D9");
        });
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__MstPermi__E5331AFA87F2D13F");
        ...
        {
            entity.HasKey(e => e.RoletypeId).HasName("PK__MstRoleT__5C2E375A873A410D");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__MstUsers__B9BE370F73CA664F");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__MstUserR__760965CC23E7FCD0");
        ...
        {
            entity.HasKey(e => e.MappingId).HasName("PK__RolePerm__5AE900459CFBC7D1");
