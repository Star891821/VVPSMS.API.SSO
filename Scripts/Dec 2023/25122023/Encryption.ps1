# Generated by SQL Server Management Studio at 20:38 on 25-12-2023

Import-Module SqlServer -MinimumVersion 22.0.59
# Set up connection and database SMO objects

$password = "<replace with your password>"
$sqlConnectionString = "Data Source=MSI;Initial Catalog=VVPSMSDBV1;User ID=sa;Password=$password;Multiple Active Result Sets=False;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Packet Size=4096;Application Name=`"Microsoft SQL Server Management Studio`""
...
# Add changes for table [dbo].[Applicants]
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.applicantname -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.applicantpassword -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.applicant_givenName -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.applicant_surname -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.applicant_phone -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.role_id -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.applicant_loginType -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
$encryptionChanges += New-SqlColumnEncryptionSettings -ColumnName dbo.Applicants.enforce2FA -EncryptionType Deterministic -EncryptionKey "CEK_Auto1"
